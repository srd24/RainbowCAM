...
\sam{Let's discuss this on Skype - below are my naive questions.}
...
\sam{Are there poles in the second quadrant}
...
\sam{reflection through the origin would generate poles in the 3rd quadrant; and if there were originally poles in the 2nd quadrant, poles in the 4th quadrant. Can we clarify this?}
...
They claim that in the high-frequency limit, the interior solution of Eq.~(\ref{H_Radial_equation}) is (see Ref.~\cite{Zhang:2011pq}). \sam{hmm `they claim' - do we agree?}
%
...
\sam{I have made v minor edits. It looks good to me, and I propose we remove both these comments during the Skype.}
