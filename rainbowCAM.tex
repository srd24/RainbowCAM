...
%
\begin{abstract}
We calculate the Regge poles of the scattering matrix for a compact gravitating body, showing that the spectrum has three branches, which we classify as surface waves, broad resonances and narrow resonances. We examine the spectrum for neutron-star-like body, and compare with the spectrum for an ultra-compact body.  for the massless scalar field and the odd-parity gravitational-wave sector.
\end{abstract}
