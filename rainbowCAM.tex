...
For any stellar model (such as a polytropic fluid sphere), the potential may in general be $C^{N}$ at the surface (and $C^{\infty}$ elsewhere). In this case, $\mathcal{R}$ and thus the broad resonance branch depends on the discontinuity in the $N$-th derivative of the potential at $r=R$. We do not go into detail here, but see Eq.~4.5 of Ref. \cite{Zhang:2011pq}. 
