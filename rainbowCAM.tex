...
\tom{Speculatively, this could be related to the long range nature of gravitational scattering by compact bodies (it is not just the body that is scattering, but the bodies extended gravitational field). By contrast, in acoustics, quantum mechanics, and optics [\emph{find citations}] the scatterer generally has a short range influence.} 
An asymptotic analysis is an important next step towards understanding the role of the background integral and higher Regge-pole overtones, both computationally and, in a semiclassical interpretation, physically.
