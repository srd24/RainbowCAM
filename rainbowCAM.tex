...
\begin{equation}\label{Approx_origin_bis}
  \phi^{(r_* \to 0)}_{\omega\lambda-1/2} \underset{\omega \to \infty}{\approx} - \sin(\frac{\left(\lambda-1/2\right)\pi}{2}-\omega r_*)\quad\quad 0\leq r_*\leq R_*
\end{equation}
...
\begin{equation}\label{lambda_Approx}
  \lambda_n \approx \frac{2 \omega R_*}{\pi}-\left(2n+\frac{1}{2}\right)-\frac{i}{\pi} \ln\left(\mathcal{R}\right)
\end{equation}
